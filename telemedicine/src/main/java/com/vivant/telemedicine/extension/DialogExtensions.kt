package com.vivant.telemedicine.extension
...
fun Activity.showDialog(
    ...
    dialogData.showImage = showImage
    dialogData.animate = animate
    dialogData.imgId = imgId
    ...
    return defaultNotificationDialog
}
    ...
    try {
        ...
        val mDatePicker = DatePickerDialog(
            ...
            DatePickerDialog.OnDateSetListener { datepicker, selectedyear, selectedmonth, selectedday ->
                ...
                val dateDiff = DateHelper.getDateDifferenceInDays(date, DateHelper.getDateAs_ddmmyy(DateHelper.currentDateAsStringddMMMyyyy))
...
fun Fragment.showTimePickerDialog(listener: OnTimeSetListener) {
    try {
        ...
        val mTimePicker = TimePickerDialog(
            context, R.style.MyDialogTheme, { timePicker, selectedHour, selectedMinute ->
